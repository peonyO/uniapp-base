<template>
  <view class="navigation_bar" :style="{ height: navbarHeight + 'px' }">
    <view
...
import { getSystemInfo, navigateBack, switchTab } from "@/common";
...
const { windowWidth, menuButtonInfo, statusBarHeight, platform, navbarHeight } = getSystemInfo();
  ...
  .navigation_bar_inner {
    ...
    .navigation_bar_left {
      ...
      .navigation_bar_btn {
        ...
        .home {
          -webkit-mask: url("data:image/svg+xml,%3Csvg t='1695276205929' class='icon' viewBox='0 0 1029 1024' version='1.1' xmlns='http://www.w3.org/2000/svg' p-id='6959' width='20' height='20'%3E%3Cpath d='M79.301957 445.095715c0-150.673718 79.301957-166.53411 182.394501-229.975676C531.323111 40.655734 491.672133 24.795343 769.228982 215.120039c95.162348 63.441566 174.464305 79.301957 174.464305 229.975676 0 467.881546 39.650978 507.532524-134.813326 507.532524-182.394501 0-126.883131-63.441566-134.813327-206.185088-23.790587-206.185088-309.277632-206.185088-325.138024 15.860391-7.930196 126.883131 39.650978 190.324697-126.883131 190.324697-182.394501 0-142.743522-15.860391-142.743522-507.532524z m166.534109 578.904285c111.02274 0 174.464305-39.650978 182.394501-158.603914 0-39.650978-7.930196-118.952935 15.860392-158.603914 15.860391-39.650978 63.441566-31.720783 71.371761-31.720782 15.860391 0 55.51137 0 71.371761 31.720782 15.860391 47.581174 7.930196 118.952935 15.860392 158.603914 0 55.51137-7.930196 87.232153 39.650978 126.883131 31.720783 31.720783 95.162348 31.720783 142.743522 31.720783 158.603914 0 237.905871-7.930196 237.905871-190.324697 0-475.811741 55.51137-515.46272-198.254892-674.066633C483.741937-54.506614 531.323111-54.506614 190.324697 167.538865 79.301957 238.910627 7.930196 262.701214 7.930196 445.095715c0 499.602329-55.51137 578.904285 237.90587 578.904285z' p-id='6960'%3E%3C/path%3E%3C/svg%3E")
            no-repeat 50% 50%;
          mask: url("data:image/svg+xml,%3Csvg t='1695276205929' class='icon' viewBox='0 0 1029 1024' version='1.1' xmlns='http://www.w3.org/2000/svg' p-id='6959' width='20' height='20'%3E%3Cpath d='M79.301957 445.095715c0-150.673718 79.301957-166.53411 182.394501-229.975676C531.323111 40.655734 491.672133 24.795343 769.228982 215.120039c95.162348 63.441566 174.464305 79.301957 174.464305 229.975676 0 467.881546 39.650978 507.532524-134.813326 507.532524-182.394501 0-126.883131-63.441566-134.813327-206.185088-23.790587-206.185088-309.277632-206.185088-325.138024 15.860391-7.930196 126.883131 39.650978 190.324697-126.883131 190.324697-182.394501 0-142.743522-15.860391-142.743522-507.532524z m166.534109 578.904285c111.02274 0 174.464305-39.650978 182.394501-158.603914 0-39.650978-7.930196-118.952935 15.860392-158.603914 15.860391-39.650978 63.441566-31.720783 71.371761-31.720782 15.860391 0 55.51137 0 71.371761 31.720782 15.860391 47.581174 7.930196 118.952935 15.860392 158.603914 0 55.51137-7.930196 87.232153 39.650978 126.883131 31.720783 31.720783 95.162348 31.720783 142.743522 31.720783 158.603914 0 237.905871-7.930196 237.905871-190.324697 0-475.811741 55.51137-515.46272-198.254892-674.066633C483.741937-54.506614 531.323111-54.506614 190.324697 167.538865 79.301957 238.910627 7.930196 262.701214 7.930196 445.095715c0 499.602329-55.51137 578.904285 237.90587 578.904285z' p-id='6960'%3E%3C/path%3E%3C/svg%3E")
            no-repeat 50% 50%;
        }
        .back {
          -webkit-mask: url("data:image/svg+xml,%3Csvg t='1695277133323' class='icon' viewBox='0 0 1024 1024' version='1.1' xmlns='http://www.w3.org/2000/svg' p-id='7200' width='20' height='20'%3E%3Cpath d='M755.882667 931.328L336.725333 512 755.882667 92.842667a34.133333 34.133333 0 0 0 0-48.469334 34.133333 34.133333 0 0 0-48.469334 0L268.117333 483.157333a34.133333 34.133333 0 0 0-9.557333 28.842667 34.133333 34.133333 0 0 0 9.557333 29.354667l439.125334 438.613333a34.133333 34.133333 0 0 0 48.64-48.64z m0 0' fill='%23333333' p-id='7201'%3E%3C/path%3E%3C/svg%3E")
            no-repeat 50% 50%;
          mask: url("data:image/svg+xml,%3Csvg t='1695277133323' class='icon' viewBox='0 0 1024 1024' version='1.1' xmlns='http://www.w3.org/2000/svg' p-id='7200' width='20' height='20'%3E%3Cpath d='M755.882667 931.328L336.725333 512 755.882667 92.842667a34.133333 34.133333 0 0 0 0-48.469334 34.133333 34.133333 0 0 0-48.469334 0L268.117333 483.157333a34.133333 34.133333 0 0 0-9.557333 28.842667 34.133333 34.133333 0 0 0 9.557333 29.354667l439.125334 438.613333a34.133333 34.133333 0 0 0 48.64-48.64z m0 0' fill='%23333333' p-id='7201'%3E%3C/path%3E%3C/svg%3E")
            no-repeat 50% 50%;
        }
      }
